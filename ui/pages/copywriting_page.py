...
class CopywritingPage(QWidget):
    ...
    def _build_ui(self):
        ...
        il.addWidget(self._section_label("原始文案"))



        btn_row = QHBoxLayout()

        sync_btn = QPushButton("同步抓取文案")
        ...
        ol.addWidget(self._section_label("生成结果 (AI绘画提示词"))
    ...
    def _sync_scraped_text(self):
        ...
        try:
            ...
            self._set_status(f"同步失败: {e}", "danger")
